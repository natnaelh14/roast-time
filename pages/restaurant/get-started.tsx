...
const GetStarted = () => {
  ...
  return (
    <div className="form-background flex min-h-[800px] w-full flex-row items-center justify-center py-16">
      <div className="flex w-5/6 flex-col items-center justify-between rounded-lg border-2 border-gray-200 bg-white px-16 py-8 dark:border-gray-secondary dark:bg-blue-dark md:w-2/3 lg:w-3/5 xl:w-2/5">
