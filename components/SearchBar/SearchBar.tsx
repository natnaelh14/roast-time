    ...
    return (
        <form className='w-fit w-[300px] md:w-[400px] m-2 md:m-6'>
            ...
            <div className="relative">
                ...
                <button type="submit" className="absolute right-2.5 bottom-2.5 bg-pink-primary hover:bg-orange-primary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2">Search</button>
            </div>
        </form>
    )
}
