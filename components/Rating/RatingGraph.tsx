export const RatingGraph = () => {
	return (
		<div className="m-10 flex w-96 flex-col lg:my-0">
			<div className="mt-4 flex items-center">
				...
				<div className="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
					<div className="h-5 rounded bg-yellow-400" style={{ width: "70%" }}></div>
				</div>
			...
			<div className="mt-4 flex items-center">
				...
				<div className="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
					<div className="h-5 rounded bg-yellow-400" style={{ width: "17%" }}></div>
				</div>
			...
			<div className="mt-4 flex items-center">
				...
				<div className="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
					<div className="h-5 rounded bg-yellow-400" style={{ width: "8%" }}></div>
				</div>
			...
			<div className="mt-4 flex items-center">
				...
				<div className="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
					<div className="h-5 rounded bg-yellow-400" style={{ width: "4%" }}></div>
				</div>
			...
			<div className="mt-4 flex items-center">
				...
				<div className="mx-4 h-5 w-2/4 rounded bg-gray-200 dark:bg-gray-700">
					<div className="h-5 rounded bg-yellow-400" style={{ width: "1%" }}></div>
				</div>
